...
export default function ChecklistsPage() {
  ...
  function ChecklistCard({
    ...
    const progressWidthClass = progressPct >= 95 ? 'w-full' : progressPct >= 80 ? 'w-4/5' : progressPct >= 65 ? 'w-3/4' : progressPct >= 50 ? 'w-2/3' : progressPct >= 35 ? 'w-1/2' : progressPct >= 20 ? 'w-1/3' : 'w-1/6';
